...
public class GlobalExceptionHandler {
	...
	//Handle Carrier Exceptions
		...
		@ExceptionHandler(CargoNotSufficentCapacity.class)
		public ResponseEntity<ResponseStructure<String>> cargoNotSufficent(CargoNotSufficentCapacity ex) {
			ResponseStructure<String> rs = new ResponseStructure<String>();
			rs.setStatuscode(HttpStatus.NOT_ACCEPTABLE.value());
			rs.setMessage(ex.getMessage());
			rs.setData("cargo not sufficent capacity");
			return new ResponseEntity<ResponseStructure<String>>(rs,HttpStatus.NOT_ACCEPTABLE);
		}
}
